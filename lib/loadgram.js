...
Loadgram.prototype.close = function (callback) {
	this.removeListener('backend::unhealthy', this._onBackendUnhealthy.bind(this));
	this.removeListener('backend::healthy', this._onBackendHealthy.bind(this));
	if (this.healthcheck.enabled) this.stopHealthCheck();
